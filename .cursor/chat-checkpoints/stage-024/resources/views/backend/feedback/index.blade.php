...
<section class="content mt-3">
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-body">
                <form method="GET" action="{{ route('manager.feedback.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a href="{{ route('manager.feedback.index') }}" class="btn btn-outline-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                    <div class="text-muted small">
                        Showing <strong>{{ $feedback->count() }}</strong> record(s)
                        @if(!empty($filters['q']) || !empty($filters['date_from']) || !empty($filters['date_to']))
                            (filtered)
                        @endif
                    </div>
                    <a href="{{ route('manager.feedback.export', request()->query()) }}"
                ...
                <div class="table-responsive">
                    <table id="dataTable"
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-4">No feedback found for the selected filters.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
