    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="selectAllCheckbox">
                ...
                <label for="selectAllProducts" class="ms-1">Select all on this page</label>
            </div>
            <small class="text-muted">Selected: <strong id="pageSelectedHint">0</strong> on page</small>
        </div>
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th width="40">
                            <input type="checkbox" id="selectAllProductsHead" title="Select all on this page">
                        </th>
                        <th>No</th>
                        <th>Category Name</th>
                        <th>Product Name</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            ...
                            @else
                            <div style="width:60px;height:60px;background:#f1f1f1;border:1px dashed #ccc;border-radius:8px;display:flex;align-items:center;justify-content:center;margin:auto;color:#888;font-size:11px;font-weight:600;">
                                No Logo
                            </div>
                            @endif
                        </td>
