                    ...
                    <div class="row">
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="pills-tab-2" data-bs-toggle="pill" data-bs-target="#pills-2" type="button" role="tab" aria-controls="pills-2" aria-selected="false">
                                                            <div class="checkout-payment-img">
                                                                <img src="assets/images/paypal-2.svg" alt="">
                                                            </div>
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link" id="pills-tab-4" data-bs-toggle="pill" data-bs-target="#pills-4" type="button" role="tab" aria-controls="pills-4" aria-selected="false">
                                                            <div class="checkout-payment-img cod">
                                                                <img src="assets/images/cod-3.svg" alt="">
                                                            </div>
                                                        ...
                                                        <div class="shop-checkout-form">
                                                            <form action="#">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <button type="submit" class="theme-btn">Login Account<i class="fas fa-arrow-right"></i></button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="shop-cart-summary mt-0">
                                <h5>Cart Summary</h5>
                                <ul>
                                    <li><strong>Sub Total:</strong> <span>Rs4,500.00</span></li>
                                    {{-- <li><strong>Discount:</strong> <span>Rs5.00</span></li> --}}
                                    <li><strong>Shipping:</strong> <span>Free</span></li>
                                    <li><strong>Taxes:</strong> <span>Rs25.00</span></li>
                                    <li class="shop-cart-total"><strong>Total:</strong> <span>Rs4,520.00</span></li>
                                </ul>
                                <div class="text-end mt-40">
                                    <a href="checkout-complete" class="theme-btn">Checkout Now<i class="fas fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
