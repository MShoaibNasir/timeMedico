...
<section class="content mt-3">
    <div class="container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 mb-3">
            <a href="{{ route('manager.area.index') }}" class="btn btn-sm {{ !request('serviceability') ? 'btn-dark' : 'btn-outline-dark' }}">All</a>
            <a href="{{ route('manager.area.index', ['serviceability' => 'serviceable']) }}" class="btn btn-sm {{ request('serviceability') === 'serviceable' ? 'btn-success' : 'btn-outline-success' }}">Serviceable</a>
            <a href="{{ route('manager.area.index', ['serviceability' => 'non_serviceable']) }}" class="btn btn-sm {{ request('serviceability') === 'non_serviceable' ? 'btn-warning' : 'btn-outline-warning' }}">Non-serviceable (Courier)</a>
            @can('area-create')
            <a href="{{ route('manager.area.create') }}" class="btn btn-sm btn-primary ms-auto">
            ...
            <table id="dataTable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($data->is_service_able)
                                <span class="badge bg-success">Serviceable</span>
                            @else
                                <span class="badge bg-warning text-dark">Non-serviceable / Courier</span>
                            @endif
                        </td>
