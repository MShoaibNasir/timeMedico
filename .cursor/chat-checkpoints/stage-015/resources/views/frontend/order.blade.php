    ...
    <div class="site-breadcrumb">
        ...
        <div class="container">
            <div class="site-breadcrumb-wrap">
                <h4 class="breadcrumb-title">Order List</h4>
            ...
            @endif">
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-1">
                                                            ...
                                                            <form action="{{ route('frontend.dashboard.reorder', encrypt($item->id)) }}" method="POST" class="d-inline">
                                                                @csrf
                                                                <button type="submit" class="btn btn-outline-primary btn-sm rounded-2" title="Reorder">
                                                                    <i class="fal fa-sync"></i> Reorder
                                                                </button>
                                                            </form>
                                                        </div>
                                                    </td>
