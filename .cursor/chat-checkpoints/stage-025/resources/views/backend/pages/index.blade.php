    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-xl-3 col-md-6">
                    <a href="{{ route('manager.master-logs.index') }}" class="text-decoration-none d-block">
                        <div class="tm-stat">
                            <div class="icon sky"><i class="fa-solid fa-clipboard-list"></i></div>
                            <div class="label">Master Logs</div>
                            <div class="value">{{ number_format($totalMasterLogs) }}</div>
                            <p class="hint mb-0">{{ number_format($totalFeedback) }} feedback · all activity</p>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="col-xl-4">
                    <div class="tm-card">
                        ...
                        <div class="tm-card-body tm-quick">
                            ...
                            <a href="{{ route('manager.master-logs.index') }}">
                                <span class="qi"><i class="fa-solid fa-clock-rotate-left"></i></span>
                                <span>
                                    <p class="qt">Master Logs</p>
                                    <p class="qs">{{ number_format($totalMasterLogs) }} activity records</p>
                                </span>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-5">
                    <div class="tm-card mb-3">
                        <div class="tm-card-head">
                            ...
                            <a href="{{ route('manager.master-logs.index') }}" class="small fw-semibold text-decoration-none" style="color:#0d9488;">View all</a>
                        </div>
                        <div class="tm-card-body p-0">
                            <div class="table-responsive">
                                <table class="table tm-table mb-0">
                                    ...
                                    <tbody>
                                        @forelse($recentMasterLogs as $log)
                                            <tr>
                                                <td>
                                                    <div class="fw-semibold">{{ $log->actor_name ?: ucfirst($log->actor_type) }}</div>
                                                    <div class="small text-muted">{{ str_replace('_', ' ', $log->source) }}</div>
                                                </td>
                                                <td>
                                                    <div>{{ \Illuminate\Support\Str::limit($log->description, 48) }}</div>
                                                    <div class="small text-muted">{{ $log->module }} · {{ $log->action }}</div>
                                                </td>
                                                <td class="small text-muted text-nowrap">
                                                    {{ optional($log->created_at)->format('d M, h:i A') }}
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="3" class="tm-empty">No activity logged yet.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
