        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                    ...
                    <form method="POST"
                          action="{{ route('manager.master-logs.clear') }}"
                          class="d-flex flex-wrap align-items-center gap-2"
                          onsubmit="return confirm('Clear old log entries? This cannot be undone.');">
                        @csrf
                        <input type="number"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    ...
                                    <form id="deleteMasterLogForm{{ $data->id }}"
                                          method="POST"
                                          action="{{ route('manager.master-logs.destroy', $data->id) }}"
                                          class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button"
                                                class="btn btn-outline-danger btn-sm"
                                                onclick="deleteMasterLog({{ $data->id }})">
                                            Delete
                                        </button>
                                    </form>
                                </td>
...
@push('specific_js')
<script>
    function deleteMasterLog(id) {
        var form = $("#deleteMasterLogForm" + id);
