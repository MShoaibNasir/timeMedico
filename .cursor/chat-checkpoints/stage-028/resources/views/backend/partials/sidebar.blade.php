    ...
    <div class="sidebar-wrapper">
        ...
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('manager.admin-notifications.index') }}" class="nav-link">
                        ...
                        <p>
                            ...
                            @php
                                ...
                                try {
                                    if (\Illuminate\Support\Facades\Auth::guard('admin')->check()
                                        && \Illuminate\Support\Facades\Schema::hasTable('admin_notifications')) {
                                        $adminUnread = \App\Models\AdminNotification::where('admin_id', Auth::guard('admin')->id())
                                            ->where('is_read', false)
                                            ->count();
                                    }
                                } catch (\Throwable $e) {
                            ...
                            @endphp
                            @if($adminUnread > 0)
                                <span class="badge bg-danger ms-1">{{ $adminUnread > 99 ? '99+' : $adminUnread }}</span>
                            @endif
                        </p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('manager.master-logs.index') }}" class="nav-link">
