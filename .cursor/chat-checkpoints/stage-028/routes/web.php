...
use App\Http\Controllers\Backend\MasterLogController;
...
Route::prefix('manager')->name('manager.')->group(function () {
    ...
    Route::middleware(['auth:admin', 'prevent-back-history'])->group(function () {
        ...
        Route::prefix('admin/dashboard/master-logs')->name('master-logs.')->controller(MasterLogController::class)->group(function () {
            Route::get('/index', 'index')->name('index');
            Route::get('/show/{id}', 'show')->name('show');
        });

        Route::prefix('admin/dashboard/notifications')->name('admin-notifications.')->controller(AdminNotificationController::class)->group(function () {
            Route::get('/index', 'index')->name('index');
            Route::get('/show/{id}', 'show')->name('show');
            Route::post('/{id}/read', 'markRead')->name('markRead');
            Route::post('/read-all', 'markAllRead')->name('markAllRead');
            Route::delete('/destroy/{id}', 'destroy')->name('destroy');
        });
...
Route::prefix('notifications')->name('frontend.notifications.')->middleware(['prevent-back-history'])->controller(NotificationController::class)->group(function () {
    Route::get('/', 'index')->name('index');
    Route::post('/{id}/read', 'markRead')->name('markRead');
    Route::post('/read-all', 'markAllRead')->name('markAllRead');
