                    ...
                    <div class="col-7 col-lg-3 col-xl-4">
                        <div class="header-middle-right">
                            <ul class="header-middle-list">
                                ...
                                <li>
                                    @php $headerUnread = Auth::guard('web')->user()->unreadAppNotifications()->count(); @endphp
                                    <a href="{{ route('frontend.notifications.index') }}" class="list-item">
                                        <div class="list-item-icon">
                                            <i class="far fa-bell"></i>
                                            @if($headerUnread > 0)
                                                <span class="badge bg-danger" style="font-size:10px;position:relative;top:-8px;left:-4px;">{{ $headerUnread > 9 ? '9+' : $headerUnread }}</span>
                                            @endif
                                        </div>
