    ...
    $metaImage = !empty($page?->image)
        ...
        : (
            $setting?->hasMedia('logo')
                ? $setting->getFirstMediaUrl('logo', 'full')
                : (
                    $setting?->hasMedia('favicon')
                        ? $setting->getFirstMediaUrl('favicon', 'full')
...
<link rel="icon" type="image/png" href="{{ $setting->getFirstMediaUrl('favicon', 'full') }}">
@endif

<!-- Apple Touch Icon -->
@if($setting->hasMedia('favicon'))
<link rel="apple-touch-icon" href="{{ $setting->getFirstMediaUrl('favicon', 'full') }}">
@endif
