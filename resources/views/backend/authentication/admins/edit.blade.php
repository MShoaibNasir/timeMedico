            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('manager.users.index') }}">Admin List</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-dark">
                        ...
                        <form action="{{ route('manager.users.update', $admin->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 checkbox-wrapper-13">
                                    ...
                                    <select class="form-control" name="roles">
                                        ...
                                        @foreach ($roles as $key => $value)
                                            <option value="{{ $value }}"
                                                {{ $admin->roles[0]->name == $value ? 'selected' : '' }}>
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
