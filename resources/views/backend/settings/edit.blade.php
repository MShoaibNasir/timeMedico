...
@section('content')
	...
	<div class="form-group mb-3">
		...
		<img src="{{ $setting->getFirstMediaUrl('logo', 'small') }}" width="100" alt="logo" class="mb-2"><br>
        @endif
	...
	<div class="form-group mb-3">
		...
		<img src="{{ $setting->getFirstMediaUrl('favicon', 'small') }}" width="25" alt="favicon" class="mb-2"><br>
        @endif
