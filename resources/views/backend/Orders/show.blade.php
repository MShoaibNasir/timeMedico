    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <!-- Status Update Form -->
                <form action="{{ route('manager.order.update', $order->id) }}" method="POST" class="d-flex align-items-center gap-2">
                    @csrf
                    @method('PUT')

                    <select name="status" class="form-select form-select-sm" style="width:160px;">
                        @foreach(['Pending','Processing','On The way','Delivered','Rejected','Returned'] as $status)
