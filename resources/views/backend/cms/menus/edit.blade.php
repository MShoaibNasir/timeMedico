                            ...
                            <div class="card-body">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="type" name="type" required>
                                        ...
                                        <option value="2" {{ $menu->type == 2 ? 'selected' : '' }}>Quick Links Footer Menu</option>
										<option value="3" {{ $menu->type == 3 ? 'selected' : '' }}>Support Center Footer Menu</option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="parent_id" name="parent_id">
                                       ...
                                       ($parent->type == 2 ? 'Quick Links Footer Menu' :
                                       ($parent->type == 3 ? 'Support Center Footer Menu' : 'Unknown Menu')) }})
                                       </option>
                                        @endforeach
                                    </select>
                                </div>
