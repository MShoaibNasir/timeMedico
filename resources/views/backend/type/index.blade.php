        ...
        <table id="dataTable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @can('type-edit')
                        <a class="btn btn-primary btn-sm" href="{{ route('manager.type.edit',$data->id) }}"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                        @endcan

                        @can('type-delete')
                        <form id="deleteAdminForm{{ $key }}"
                            method="POST"
                            action="{{ route('manager.type.destroy', $data->id) }}"
