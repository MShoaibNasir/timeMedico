...
<section class="flat-title-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="bg-light contact-content p-5 round-30 shadow">
                    <h4>Drop Us A Line</h4>
                    <p class="body-2 text-variant-1 pb-5">Feel free to connect with us through our online channels for updates, news, and more.</p>
                    <form id="contactform" method="post" action="{{route('frontend.uploadContact')}}" class="form-contact" >
                        @csrf
                        <div class="box grid-2 py-3 gap-20">
                            <fieldset>
                                <label for="name py-5">Full Name:</label>
                        ...
                        <div class="box grid-2  gap-20 mb-3">
                            <fieldset>
                        ...
                        <fieldset>
                            <label for="message mt-3">Your Message:</label>
                            <textarea name="message" class="form-control" cols="30" rows="10" placeholder="Message" id="message" required></textarea>
                        </fieldset>
                        <div class="send-wrap">
                            <button class="tf-btn primary size-1 my-3" type="submit">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <ul class="box-social">
                                <li><a href="#" class="item">
                                        <svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9.00879 10.125L9.50871 6.86742H6.38297V4.75348C6.38297 3.86227 6.81961 2.99355 8.21953 2.99355H9.64055V0.220078C9.64055 0.220078 8.35102 0 7.11809 0C4.54395 0 2.86137 1.56023 2.86137 4.38469V6.86742H0V10.125H2.86137V18H6.38297V10.125H9.00879Z" fill="#161E2D"></path>
                                        </svg>
                                    </a></li>
                                <li><a href="#" class="item">
...
<section class="">
    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7242.152785919343!2d67.037922!3d24.827061!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb33db641537feb%3A0x59cd8577a91372d2!2sPakistan%20Institute%20of%20Corporate%20Governance!5e0!3m2!1sen!2sus!4v1750312819403!5m2!1sen!2sus" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</section>
</div>
