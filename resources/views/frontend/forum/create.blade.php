        ...
        <div class="container">
            <div class="flat-img-with-text style-3 bg-primary-new">
                <div class="content-left img-animation wow animated animated animated animated animated animated" style="visibility: visible;">
                    <h1 class="hub-directors text-white">Create Forum</h1>
                                ...
                                <table class="form-table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="title" class="form-input-field"
                                                    placeholder="Enter Title..." required>
                                            </td>
                                        </tr>
                                       
                                        <tr>
                                            <td><strong>Detail About Topic</strong></td>
                                            <td>
                                            <textarea name="detail" class="form-input-field"
                                                    placeholder="Enter Detai..."></textarea>                                            </td>
                                        </tr>
                                        <tr>
