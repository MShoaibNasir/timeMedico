                ...
                <div class="col-md-12 col-lg-6 col-xxl-6">
                    <div class="shop-single-info">
                        ...
                        <div class="shop-single-sortinfo">
                            <ul>
                                <li>Stock: <span>{{ $product->in_stock==1 ? 'Available' : 'Not Available'}}</span></li>
            ...
            <div class="shop-single-details">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-tab2" data-bs-toggle="tab" data-bs-target="#tab2" type="button" role="tab" aria-controls="tab2" aria-selected="false" tabindex="-1">Additional
                            Info</button>
