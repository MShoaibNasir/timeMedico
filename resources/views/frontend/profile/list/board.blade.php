...
<div class="table-wrapper">
    <h5 class="mb-3" style="font-weight:600;">Board Committee Memberships Data</h5>
    ...
    <table class="table table-borderless align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$data->end_date}}</td>
                <td>   
                <a class="btn btn-danger btn-sm deleteBoard" data-id="{{$data->id}}">
...
$('.deleteBoard').click(function () {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "This board will be deleted permanently!",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "{{ route('frontend.board.data.delete') }}",
                method: 'POST',
                beforeSend: function () {
                    Swal.fire({
                        title: 'Deleting Data...',
                ...
                success: function (response) {
                    ...
                    Swal.close();
                    showBoardData(); // refresh board data
                    Swal.fire(
                        'Deleted!',
