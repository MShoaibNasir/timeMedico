...
<div class="table-wrapper">
    <h5 class="mb-3" style="font-weight:600;">Additional Certificate Data</h5>
    ...
    <table class="table table-borderless align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$data->skills}}</td>
                <td>{{$data->issuing_organization}}</td>
                <td>{{$data->issue_date}}</td>
           
                <td>   
                <a class="btn btn-danger btn-sm deleteCertificate" data-id="{{$data->id}}">
...
$('.deleteCertificate').click(function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "{{ route('frontend.certificate.data.delete') }}",
                method: 'POST',
                beforeSend: function () {
                    Swal.fire({
                        title: 'Deleting Data...',
                ...
                success: function (response) {
                    ...
                    Swal.close();
                    showAdditionCertificateList(); // refresh certificate list
                    Swal.fire(
                        'Deleted!',
