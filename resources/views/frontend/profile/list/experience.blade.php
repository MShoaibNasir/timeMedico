...
<div class="table-wrapper">
    <h5 class="mb-3" style="font-weight:600;">Experience Data</h5>
    ...
    <table class="table table-borderless align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$data->end_date}}</td>
                <td>{{$data->country}}</td>
                {{-- <td>{{$data->affidavit==1?''}}</td> --}}
                <td>   
                <a class="btn btn-danger btn-sm deleteExperience" data-id="{{$data->id}}">
...
$('.deleteExperience').click(function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "{{ route('frontend.experienceDelete') }}",
                method: 'POST',
                beforeSend: function () {
                    Swal.fire({
                        title: 'Deleting Data...',
                ...
                success: function (response) {
                    ...
                    Swal.close();
                    showProfessionalExperience(); // refresh experience list
                    Swal.fire(
                        'Deleted!',
