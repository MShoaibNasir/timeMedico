        ...
        <div class="container">
            <div class="flat-img-with-text style-3 bg-primary-new">
                <div class="content-left img-animation wow animated animated animated animated animated animated"
                    ...
                    <img class="lazyload" src="{{asset('frontend/images/banner/board-of-directors.png')}}" alt="image"
                        class="img-fluid">
                    <div
                ...
                <div class="mx-auto mt-5">
                 <div class="mt-3 pt-3   mx-auto">
                            ...
                            <div class="box grid-1 gap-30 mt-5 mb-4">
                                <fieldset class="box-fieldset">
                            ...
                            <div class="box-btn">
                            <a href="#" class="tf-btn primary my-4">Submit</a>
