...
<head>
    <meta charset="UTF-8">
    <title>Contact Form Submission - TIMES MEDICO</title>
</head>
    ...
    <table align="center" width="600" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td
                ...
                <img src="{{ asset('frontend/assets/images/timemedio-logo.png') }}" alt="TIMES MEDICO Logo" height="60"
                    style="margin-bottom: 10px;">
                <h2 style="color: #ffffff; margin: 0;">TIMES MEDICO</h2>
        ...
        <tr>
            <td
                ...
                &copy; {{ now()->year }} TIMES MEDICO. All rights reserved.
            </td>
        </tr>
    </table>
</body>
