...
<body>
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>To get started, please pay to subscribe:</p>

            <p style="text-align: center; margin: 30px 0;">
                <a href="{{route('frontend.verify.email',[$user['id'] ])}}" class="verify-btn">Pay Now</a>
            </p>

            <p>If you didn’t create this account, please ignore this email — your information is safe with us.</p>
        </div>
