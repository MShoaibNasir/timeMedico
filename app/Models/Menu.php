...
class Menu extends Model
{
    ...
    public const TYPE_FOOTER_COLUMN_1 = 2;
    public const TYPE_FOOTER_COLUMN_2 = 3;
	
	use HasFactory;
    protected $fillable = ['type','parent_id','title','title_ur','icon','redirection_type','page_id','route','url','status','sorting'];
    ...
    public function getRedirectUrlAttribute()
    {
        try {
            return match ($this->redirection_type->value) {
                1 => route('frontend.page.show', $this->page->slug),
                2 => route($this->route),
                3 => $this->url,
                default => '#',
            };
