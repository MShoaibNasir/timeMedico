...
use App\Http\Requests\Frontend\Communication\AddRequest;
use App\Http\Requests\Frontend\Communication\UpdateRequest;
...
class CommunicationController  extends BaseController
{
    public function __construct(
        protected CommunicationServices $communicationServices
    ) {}
    ...
    {
        $data = $this->communicationServices->store($request->all());
        return $this->sendResponse($data, 'Data Create Successfully!.');
    }
    ...
    public function update(UpdateRequest $request)
    {
        ...
        $data = $this->communicationServices->update($request->all());
        return $this->sendResponse($data, 'Data update Successfully!.');
    }
